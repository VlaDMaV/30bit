...
* В .env файле указывается токен бота и айди админ чата, в который будут приходить сообщения и отзывы пользователей.
...
```http://vladmav.ddns.net:8080```. Просьба в случае недоступности сайта обратиться ко мне в личку (мало ли что произошло с 
платой, может свет выключили, постараюсь починить в кратчайшие сроки). Скорость ответа бота так же связана с тем, что запущена на плате (она сама по себе слабенькая, так и плюс там, где она стоит не особо быстрый интернет). При желании убедиться в этом, можно запустить бота у себя и увидеть, что он отвечает быстро.
